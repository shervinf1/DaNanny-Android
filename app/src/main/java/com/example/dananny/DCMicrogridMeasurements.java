...
public class DCMicrogridMeasurements {
    ...
    DCMicrogridMeasurements(String d, String mwt, String iBattery, String vBattery, String vAvg, String wAvg, String dcload, float pow){
